...
func setupAWSSMPFsys(t *testing.T, dir string) fs.FS {
	...
	fsys = WithSSMClientFS(clientWithValues(t, map[string]*testVal{
...
func setupOpaqueAWSSMPFsys(t *testing.T, prefix string) fs.FS {
	fsys, err := New(tests.MustURL("aws+smp:" + prefix))
	assert.NoError(t, err)
...
func TestAWSSMPFS_TestFS(t *testing.T) {
	...
	// test opaque
	fsys = setupOpaqueAWSSMPFsys(t, "b")
	assert.NoError(t, fstest.TestFS(fsys,
		"ba", "bb", "bc",
		"ba/baa", "ba/bab",
...
func TestAWSSMPFS_Stat(t *testing.T) {
	...
	fsys = WithSSMClientFS(clientWithValues(t,
		map[string]*testVal{},
...
func TestAWSSMPFS_ReadDir(t *testing.T) {
	...
	fsys = WithSSMClientFS(clientWithValues(t, nil), fsys)
...
func TestAWSSMPFS_ReadDir_Opaque(t *testing.T) {
	fsys := setupOpaqueAWSSMPFsys(t, "")
